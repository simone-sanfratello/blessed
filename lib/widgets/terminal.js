...
function Terminal(options) {
  ...
  this.keyable = this.options.keyable
  this.keys = this.options.keys
  this.grabKeys = this.options.grabKeys
  this.lockKeys = this.options.lockKeys
  this.mouse = this.options.mouse
  // @todo fix scroll
...
Terminal.prototype.bootstrap = function () {
  ...
  this.term = require('term.js')({
    ...
    border: this.border,
    keyable: this.keyable,
    keys: this.keys,
    grabKeys: this.grabKeys,
